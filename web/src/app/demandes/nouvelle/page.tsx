  ...
  const submit = async () => {
    ...
    try {
      ...
      if (err instanceof ApiError && (err.code === "INSUFFICIENT_ROLE" || err.status === 403)) {
        setError("Votre compte devrait pouvoir publier une demande. Le backend utilisé n’applique pas encore la règle vendeur + acheteur.");
      ...
      <section className={styles.spaceContent}>
        ...
        <div className={styles.requestLayout}>
          <div className={styles.requestColLeft}>
            ...
            {!authLoading && !user && (
              <p className={styles.wizardError}>
                Connectez-vous pour publier une demande.
              </p>
            )}
          ...
          <div className={styles.wizardFooter}>
            <Link href="/demandes" className={styles.wizardCancelBtn}>
